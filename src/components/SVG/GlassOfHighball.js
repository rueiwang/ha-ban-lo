...
const GlassOfHighball = (props) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient spreadMethod="repeat" id="three_opacity_stops" x1="0%" y1="100%" x2="0%" y2="0%">
          <stop
            offset={`${percent}%`}
            style={{
              stopColor: '#f7c242',
      ...
      <rect x="2.5" y="5" fill="url(#three_opacity_stops)" stroke="#000000" strokeWidth="5" strokeMiterlimit="10" width="204.5" height="426.5" />
